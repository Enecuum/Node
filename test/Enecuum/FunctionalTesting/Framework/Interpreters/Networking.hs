module Enecuum.FunctionalTesting.Framework.Interpreters.Networking where
...
import qualified Enecuum.FunctionalTesting.Framework.Interpreters.Network as Impl
...
data TestConnection = TestConnection (MVar NodeRuntime) Connection
...
relayRequest nodeRt conn req = do
  atomically
      ...
      $ RelayRpcRequest (_clientAddress conn) (_serverAddress conn) req
