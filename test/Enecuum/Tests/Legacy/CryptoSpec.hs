...
spec :: Spec
spec = do
    describe "Legacy parsing tests" $ fromHUnitTest parsingTestSuite
    ...
    describe "Legacy Transaction signing / serialization tests" $ do
        it "Serialize Transaction" $ do
            ...
            unwords txHex
                `shouldBe` "01 01 00 00 00 00 00 00 00 21 1f c8 de b7 d7 bf 20 a8 14 8a de 2b 3c c3 ed ba 89 a4 95 13 40 d3 96 6f 8f ff 3b 7a 09 e7 44 51 01 00 00 00 00 01 00 00 00 00 00 06 9d 17 00 00 00 00 00 00 00 00 00 00 01"
