...
args =
    ...
    , Option ['S']
             ["transactions"]
             (ReqArg TransactionsFile "transactionsFile")
             "csv file contains transactions should be sent"
...
getAllKblocks ch = do
    ...
    case result of
        ...
        (Right kbs) -> prettyPrint
            $ sortBy (\(_, b1) (_, b2) -> compare (_number (b1 :: MacroblockBD)) (_number (b2 :: MacroblockBD))) kbs
