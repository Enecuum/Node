    ...
    processingOfBroadcast aMd aMsg = do
        ...
        case aMsg of
            ...
            INeedNeighbors (toNodeId -> aNodeId) aHostAddress aPortNumber -> do
                writeLog (aData^.infoMsgChan) $ "Accepted msg from the " ++
    ...
    processingOfBroadcast aMd aMsg = do
        ...
        case aMsg of
            ...
            BroadcastShard aShard -> do
                writeLog (aData^.infoMsgChan) $ "Accepted new shard from broadcast. The shard is " ++ show aShard
            ...
            BroadcastPosition     aMyNodeId aNodePosition  -> do
                writeLog (aData^.infoMsgChan) $ "Accepted new position for the node." ++
